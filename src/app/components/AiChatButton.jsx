  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      ...
      <motion.button
        ...
        className={`
          w-14 h-14 rounded-full flex items-center justify-center bg-dark-neutral 
            hover:bg-hover-gray 
            active:bg-active-lavender 
            p-3 
            border border-deep-rose 
            transition-all duration-200 
            focus:outline-none 
            focus:ring-2 focus:ring-icon-rose/30 
            hover:shadow-lg
